...
import br.com.querango.restaurante.entity.Endereco;
import br.com.querango.restaurante.vo.ClienteVo;
...
public class EnderecoDao {
        ...
        public List<ClienteVo> consultarClientes(final String estado,final String cidade,final String rua) {
            String jpql = "SELECT new br.com.querango.restaurante.vo.ClienteVo(e.cliente.clienteId.cpf, e.cliente.nome)" +
